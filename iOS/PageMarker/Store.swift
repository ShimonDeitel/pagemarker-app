...
final class Store: ObservableObject {
    ...
    private let fileName = "pagemarker_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Textbook One", detail: "First example entry.", date: now),
            Entry(title: "Sample Textbook Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Textbook Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
